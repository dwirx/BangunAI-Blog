...
```mermaid
flowchart TD
    A["🎤 Klaim Michael Franzese"] --> B["Klaim pertama: sting operation sering menciptakan crime"]
    A --> C["Klaim kedua: aparat kadang langgar hukum demi tangkap pelanggar hukum"]
    A --> D["Klaim ketiga: keberhasilan aparat sering diukur dari arrest bukan safer streets"]
    A --> E["Klaim keempat: paid informants jarang benar-benar reliable"]
    A --> F["Klaim kelima: mafia tidak hanya hidup dari fear and intimidation"]
...
- Sumber transkrip: [YouTube — 1 Ex-Mafia Boss vs 20 Cops (ft. Michael Franzese) Surrounded](https://www.youtube.com/watch?v=EEd5cvHnhPQ)
