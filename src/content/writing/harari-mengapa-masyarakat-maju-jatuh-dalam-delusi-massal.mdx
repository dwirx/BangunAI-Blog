...
graph LR
    ...
    subgraph JawabanHarari["Jawaban Harari"]
        A2["📡 Nexus\n'Masalahnya bukan alam kita'\n'Masalahnya ada di\ndalam informasi kita'\n'Manusia baik + info buruk\n= keputusan buruk'"]
    end
    
    Q["❓ Mengapa manusia\nmenghancurkan diri sendiri?"] --> JawabanLama
    Q --> JawabanHarari
...
flowchart TD
    ...
    Cerita["📖 Cerita / Narasi\nIdeologi, Agama,\nNasionalisme, Kapitalisme,\nKomunisme, Mitologi"]
    Manusia["👥 Jutaan Manusia\nyang harus Bekerjasama"]
    
    Fakta -->|"Tidak cukup untuk\nmemotivasi"| Manusia
    Cerita -->|"✅ Memberi motivasi,\nmakna, dan alasan"| Manusia
    
    Manusia --> Hasil["🚀 Proyek Besar\nTercapai\n(Bom Atom, Pembangunan Bangsa,\nRevolusi, Eksplorasi Luar Angkasa)"]
...
graph TD
    ...
    subgraph AISejati["AI Sejati"]
        A1["🤖 Mesin Kopi AI\n'Saya memperhatikanmu selama\nsebulan terakhir. Berdasarkan data\ndan ekspresi wajahmu saat ini,\nsaya memprediksi kamu ingin espresso.\nSudah saya siapkan.'"]
        A2["💡 Lebih jauh:\n'Saya menciptakan minuman baru\nyang belum pernah ada sebelumnya.\nSaya menyebutnya \"bestpreso\".\nSudah saya siapkan untuk kamu.'"]
        A1 --> A2
    end
...
graph TD
    subgraph JaringanOrganik["Jaringan Organik"]
        ...
        O2["💤 Butuh Istirahat\nSiang/Malam, Musim,\nWaktu Keluarga"]
        O3["🔒 Selalu Ada Privasi\nBahkan KGB tidak bisa\nmemonitor semua orang\nsetiap saat"]
        O1 --> O2 --> O3
    end
    
    subgraph JaringanAnorganikAI["Jaringan Anorganik AI"]
        A1["🤖 AI & Algoritma"]
        A2["⚡ Tidak Pernah Istirahat\n24/7/365\nTidak perlu tidur\nTidak perlu keluarga"]
        A3["👁️ Potensi Pengawasan Total\nSetiap kata, setiap langkah,\nsetiap ekspresi wajah\nbisa dipantau selamanya"]
        A1 --> A2 --> A3
    end
...
graph LR
    subgraph DuniaLama["Dunia Lama"]
        H1["👨‍💼 Manajer Bank Manusia\n'Aplikasi pinjaman kamu\nditolak karena risiko kredit'\n\n✅ Kamu bisa tanya kenapa\n✅ Kamu bisa jelaskan situasimu\n✅ Ada akuntabilitas manusiawi"]
    end
    
    subgraph DuniaBaru["Dunia Baru"]
        A1["🤖 Algoritma AI Bank\n'DITOLAK'\n\nKenapa? Karena model\nmengindikasikan risiko tinggi.\nModel mana? Tidak diketahui.\nFaktor apa? Tidak diketahui."]
        A2["❌ Tidak ada manusia\nyang bisa kamu tanya\n❌ Tidak ada penjelasan\nyang bisa dipahami\n❌ Akuntabilitas kabur"]
        A1 --> A2
    end
...
```mermaid
graph TD
    SC["🔄 Mekanisme Koreksi-Diri\n(Self-Correcting Mechanisms)"]
    
    SC --> E1["🗳️ Pemilihan Umum\nBerikan kekuasaan → Coba kebijakan\n→ Jika salah, ganti pemimpin\n→ Coba lagi"]
    SC --> E2["🔬 Ilmu Pengetahuan Modern\nPublikasi ilmiah = koreksi\nterhadap publikasi sebelumnya\nEinstein mengoreksi Newton\nNewton tidak dianggap 'suci'"]
    SC --> E3["📜 Konstitusi Amerika\nAwalnya mengizinkan perbudakan\nAmendemen mengubahnya\nMekanisme koreksi ada dalam sistem"]
    
    subgraph TanpaKoreksiDiri["Tanpa Koreksi-Diri"]
        X1["📖 Agama Tradisional\nKitab suci tidak bisa diamendemen\nTidak ada mekanisme koreksi\nKesalahan moral abadi"]
        X2["👑 Diktatoritas\nTidak ada cara untuk\nmengidentifikasi & mengoreksi\nkesalahan Putin atau Maduro"]
    end
...
graph LR
    subgraph DietMakanan["Diet Makanan"]
        F1["❌ Junk food berlebihan\n→ Tubuh sakit"] 
        F2["✅ Makanan bergizi, porsi tepat\n→ Tubuh sehat"]
    end
    
    subgraph DietInformasi["Diet Informasi"]
        I1["❌ Junk information berlebihan\n(konten penuh kebencian,\nketakutan, keserakahan)\n→ Pikiran sakit"]
        I2["✅ Informasi berkualitas, dosis tepat\n(kadang puasa informasi)\n→ Pikiran sehat"]
    end
