...
```mermaid
graph LR
    subgraph Jawaban Lama
        A1["🙏 Teologi & Mitologi\n'Ada yang salah dalam\nalam manusia'\n'Dosa asal'\n'Keterbatasan manusiawi'"]
    end
    
    subgraph Jawaban Harari
        A2["📡 Nexus\n'Masalahnya bukan alam kita'\n'Masalahnya ada di\ndalam informasi kita'\n'Manusia baik + info buruk\n= keputusan buruk'"]
    end
    
    Q["❓ Mengapa manusia\nmenghancurkan diri sendiri?"] --> Jawaban Lama
    Q --> Jawaban Harari
    
    style Jawaban Harari fill:#1b5e20,stroke:#0a3d0a,color:#fff
    style Jawaban Lama fill:#4a148c,stroke:#38006b,color:#fff
```
...
graph TD
    ...
    subgraph Jaringan Anorganik AI
        A1["🤖 AI & Algoritma"]
