...
## 🧠 The Deductive Process: Breakdown Step-by-Step

Holmes tidak "tiba-tiba tahu jawabannya" seperti kesan yang sering muncul. Ada **proses sistematis** yang berjalan di kepalanya.

### 🎯 The 7-Step Holmes Reasoning Process

```mermaid
graph TB
    subgraph "Phase 1: Data Collection"
        A["👁️ STEP 1: OBSERVE<br/>━━━━━━━━━━━━━━━<br/>Collect raw sensory data<br/>Visual • Auditory • Olfactory<br/>Tactile • Gustatory"]
        B["🔍 STEP 2: NOTICE<br/>━━━━━━━━━━━━━━━<br/>Identify anomalies & patterns<br/>What's missing?<br/>What's unusual?"]
    end
    
    subgraph "Phase 2: Analysis"
        C["📚 STEP 3: CLASSIFY<br/>━━━━━━━━━━━━━━━<br/>Match with knowledge base<br/>Chemistry • Anatomy<br/>Botany • Criminology"]
        D["💡 STEP 4: HYPOTHESIZE<br/>━━━━━━━━━━━━━━━<br/>Generate 3-5 explanations<br/>Multiple possibilities<br/>No bias"]
    end
    
    subgraph "Phase 3: Deduction"
        E["❌ STEP 5: ELIMINATE<br/>━━━━━━━━━━━━━━━<br/>Remove impossibilities<br/>Test each hypothesis<br/>against facts"]
        F["✅ STEP 6: DEDUCE<br/>━━━━━━━━━━━━━━━<br/>Select most probable<br/>Occam's Razor<br/>Simplest = Best"]
    end
    
    subgraph "Phase 4: Validation"
        G["🔬 STEP 7: VERIFY<br/>━━━━━━━━━━━━━━━<br/>Test with new evidence<br/>Make predictions<br/>Confirm hypothesis"]
    end
    ...
    F --> G
    G --> H{Confirmed?}
    H -->|"✅ Yes"| I["🎯 CASE SOLVED<br/>━━━━━━━━━━━<br/>Conclusion reached<br/>Evidence verified<br/>Justice served"]
    H -->|"❌ No"| J["🔄 REVISE<br/>━━━━━━━━━━━<br/>New data found<br/>Theory disproven"]
    J --> D
...
## 👁️ Step 1: OBSERVE (Mengumpulkan Data Mentah)
...
Holmes secara mental membuat **matrix observasi**:
...
<Callout type="tip" title="💡 Latihan: The 5-Minute Scan">
**Praktik:**

1. Pilih 1 ruangan
2. Set timer 5 menit
3. **Hanya observasi** (jangan interpretasi dulu!)
4. Catat semua yang Anda lihat dalam notebook

**Goal:** 50+ item dalam 5 menit

**Level up:** Tutup mata, recall semua item. Check akurasi. 🎯
</Callout>

---

## 🔍 Step 2: NOTICE (Identifikasi Anomali & Pola)
...
<Callout type="important" title="🎯 Prinsip: Absence as Evidence">
**Holmes mengajarkan:** **"Tidak adanya sesuatu adalah bukti."**

**Contoh modern:**

- Tidak ada jejak digital → orang ini tech-savvy (tahu cara hapus jejak)
- Tidak ada postingan sosmed → introvert / private / deactivated
- Tidak ada foto keluarga di meja → workaholic / relasi bermasalah

**Absence tells a story.** 🕵️
</Callout>

### 🧩 Pattern Recognition

Holmes punya **mental database** pola kriminal:
...
## 📚 Step 3: CLASSIFY (Mencocokkan dengan Knowledge Base)

**Tujuan:** Mengaktifkan **pengetahuan relevan** dari arsip mental.

Holmes punya **knowledge base super spesifik**. Mari kita breakdown **setiap ilmu** yang ia kuasai.

### 🧬 Holmes' Knowledge Matrix

```mermaid
mindmap
  root((🧠 HOLMES<br/>KNOWLEDGE<br/>BASE))
    🧪 Chemistry
      Blood Analysis
      Poison Detection
      Tobacco Ash 140 types
      Forensic Tests
    🩺 Anatomy
      Time of Death
      Wound Analysis
