...
graph LR
    ...
    style G fill:#ffd,stroke:#333,stroke-width:3px
```
...
flowchart TD
    ...
    style First fill:#9f9,stroke:#333,stroke-width:2px
    style Coop fill:#9f9,stroke:#333,stroke-width:2px
    style Defect fill:#f99,stroke:#333,stroke-width:2px
    style Forgive fill:#9ff,stroke:#333,stroke-width:2px
```
