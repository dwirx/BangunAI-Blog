...
| UML Diagrams | ✅ | Class, state, ER, gantt |
...
classDiagram
    ...
    class ContentEngine {
        +getContentBySlug(slug) Post
        +getReadBySlug(slug) ReadItem
        +getAllPosts() Post[]
    }
    ContentEngine --> Post : manages
    ContentEngine --> ReadItem : manages
    Post <|-- Article
    Post <|-- Note
    Post <|-- Essay
```
...
```mermaid
gantt
    title BangunAI Development Timeline
    dateFormat  YYYY-MM-DD
    section Core
        MDX Engine        :done, 2025-11-01, 30d
        Routing & Layout  :done, 2025-11-15, 20d
    section Features
        Callouts          :done, 2025-12-01, 7d
        Mermaid Diagrams  :done, 2025-12-08, 7d
        LaTeX Math        :done, 2025-12-15, 5d
        WikiLinks         :done, 2025-12-20, 5d
    section Polish
        Graph View        :done, 2026-01-01, 14d
        Dark Mode         :done, 2026-01-15, 7d
        UML Diagrams      :done, 2026-02-10, 3d
```
